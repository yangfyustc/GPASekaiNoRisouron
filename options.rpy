...
define build.name = "GPASekaiNoRisouron"
...
define config.main_menu_music = "audio/BGM/桜吹雪の誓い_ゆうり(from Yuli Audio Craft).ogg"
...
define config.save_directory = "GPASekaiNoRisouron-1740662782"
